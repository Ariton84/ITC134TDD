...
class TestTemperature extends PHPUnit_Framework_TestCase {
	...
	function testCelsiusToKelvin() {
	  ...
	  $this->assertRegExp('/error/i', $myTemp->c2k(-274), "-274 Celsius should generate error message");	
	}
	function testCelsiusToFahrenheit() {
	  ...
	  $this->assertRegExp('/error/i', $myTemp->c2f(-274), "-274 Celsius should generate error message");	
	}
	...
	function testFahrenheitToKelvin() {
	  ...
	  $this->assertRegExp('/error/i', $myTemp->f2k(-700), "-700 Fahrenheit should generate error message");	
	}
	function testFahrenheitToCelsius() {
	  ...
	  $this->assertRegExp('/error/i', $myTemp->f2c(-700), "-700 Fahrenheit should generate error message");	
	}
	...
	function testKelvinToCelsius() {
	  ...
	  $this->assertRegExp('/error/i', $myTemp->k2c(-10), "-10 Kelvin to Celsius should generate error message");	
