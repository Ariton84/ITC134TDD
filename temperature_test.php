...
class TestTemperature extends PHPUnit_Framework_TestCase {
	...
	function testCelsiusToKelvin() {
	  ...
	  assertEqual($myTemp->c2k(100), 373, "100 Celsius is 373 Kelvin");
	  assertEqual($myTemp->c2k(0), 273, "0 Celsius is 373 Kelvin");
	  assertPattern('/error/i', $myTemp->c2k(-274), "-274 Celsius should generate error message");	
	}
